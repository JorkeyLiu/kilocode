export const dict = {
  "agentManager.catalog.previewTitle": "Carregando sessões recentes…",
  "agentManager.catalog.previewStatus": "Carregando sessões…",
  "agentManager.catalog.retry": "Tentar novamente",
