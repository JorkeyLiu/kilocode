 ...
 * Sticky header above the chat messages showing session title and
 * cost / context usage, plus todo progress when the session has todos.
 *
 * When expanded, shows the task timeline (colored bars representing
 * session activity) and the token usage breakdown.
 */
