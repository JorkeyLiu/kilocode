...
export const dict = {
  ...
  "provider.apiKey.manage.loading": "Kaydedilen API anahtarı yükleniyor...",
  "provider.apiKey.manage.error": "API anahtarı yüklenemedi",
  "provider.apiKey.manage.description":
    "{{provider}} için kaydedilen API anahtarınız aşağıda gösterilmektedir. Güncelleyin veya kaldırın.",
  "provider.connect.apiKey.show": "API Anahtarını Göster",
  "provider.connect.apiKey.hide": "API Anahtarını Gizle",
  ...
  "ui.permission.configProtected.edit": "Yapılandırma dosyası düzenlemeleri her zaman onay gerektirir",
  "ui.permission.configProtected.access": "Kilo yapılandırmasına erişim her zaman onay gerektirir",
  "ui.permission.configProtected.scope": "Kaydedilen onaylar yalnızca {{agent}} ve bu tam yollar için geçerlidir.",
  "ui.permission.configProtected.thisAgent": "bu aracı",
  "ui.permission.configProtected.addToAllowed": "Bu aracı ve bu tam yollar için onay kaydet",
  "ui.permission.configProtected.removeFromAllowed": "Bu aracı ve bu tam yollar için kaydedilen onayı kaldır",
  "ui.permission.configProtected.addToDenied": "Bu aracı ve bu tam yollar için reddetme kaydet",
  "ui.permission.configProtected.removeFromDenied": "Bu aracı ve bu tam yollar için kaydedilen reddetmeyi kaldır",
  ...
  "settings.config.source.global": "Genel yapılandırma",
  "settings.config.source.local": "Çalışma alanı .kilo yapılandırması",
