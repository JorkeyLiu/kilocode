...
export const dict = {
  ...
  "provider.apiKey.manage.loading": "Ładowanie zapisanego klucza API...",
  "provider.apiKey.manage.error": "Nie udało się załadować klucza API",
  "provider.apiKey.manage.description":
    "Twój zapisany klucz API dla {{provider}} jest wyświetlany poniżej. Zaktualizuj lub usuń go.",
  "provider.connect.apiKey.show": "Pokaż klucz API",
  "provider.connect.apiKey.hide": "Ukryj klucz API",
  ...
  "ui.permission.configProtected.edit": "Edycje plików konfiguracyjnych zawsze wymagają zatwierdzenia",
  "ui.permission.configProtected.access": "Dostęp do konfiguracji Kilo zawsze wymaga zatwierdzenia",
  "ui.permission.configProtected.scope": "Zapisane zatwierdzenia dotyczą tylko {{agent}} i tych dokładnych ścieżek.",
  "ui.permission.configProtected.thisAgent": "tego agenta",
  "ui.permission.configProtected.addToAllowed": "Zapisz zatwierdzenie dla tego agenta i tych dokładnych ścieżek",
  "ui.permission.configProtected.removeFromAllowed":
    "Usuń zapisane zatwierdzenie dla tego agenta i tych dokładnych ścieżek",
  "ui.permission.configProtected.addToDenied": "Zapisz odmowę dla tego agenta i tych dokładnych ścieżek",
  "ui.permission.configProtected.removeFromDenied": "Usuń zapisaną odmowę dla tego agenta i tych dokładnych ścieżek",
  ...
  "settings.config.source.global": "Konfiguracja globalna",
  "settings.config.source.local": "Konfiguracja .kilo obszaru roboczego",
