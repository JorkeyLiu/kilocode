...
export const dict = {
  ...
  "provider.apiKey.manage.loading": "Indlæser gemt API-nøgle...",
  "provider.apiKey.manage.error": "Kan ikke indlæse API-nøgle",
  "provider.apiKey.manage.description": "Din gemte API-nøgle for {{provider}} vises nedenfor. Opdater eller fjern den.",
  "provider.connect.apiKey.show": "Vis API-nøgle",
  "provider.connect.apiKey.hide": "Skjul API-nøgle",
  ...
  "ui.permission.configProtected.edit": "Redigering af konfigurationsfiler kræver altid godkendelse",
  "ui.permission.configProtected.access": "Adgang til Kilo-konfiguration kræver altid godkendelse",
  "ui.permission.configProtected.scope": "Gemte godkendelser gælder kun for {{agent}} og disse nøjagtige stier.",
  "ui.permission.configProtected.thisAgent": "denne agent",
  "ui.permission.configProtected.addToAllowed": "Gem godkendelse for denne agent og disse nøjagtige stier",
  "ui.permission.configProtected.removeFromAllowed": "Fjern gemt godkendelse for denne agent og disse nøjagtige stier",
  "ui.permission.configProtected.addToDenied": "Gem afvisning for denne agent og disse nøjagtige stier",
  "ui.permission.configProtected.removeFromDenied": "Fjern gemt afvisning for denne agent og disse nøjagtige stier",
  ...
  "provider.custom.models.fetch.available": "Tilgængelige fra API",
  ...
  "settings.config.source.global": "Global konfiguration",
  "settings.config.source.local": "Arbejdsområde .kilo-konfiguration",
