...
export const dict = {
  ...
  "ui.permission.configProtected.edit": "Redigering av konfigurasjonsfiler krever alltid godkjenning",
  "ui.permission.configProtected.access": "Tilgang til Kilo-konfigurasjon krever alltid godkjenning",
  "ui.permission.configProtected.scope": "Lagrede godkjenninger gjelder bare for {{agent}} og disse nøyaktige stiene.",
  "ui.permission.configProtected.thisAgent": "denne agenten",
  "ui.permission.configProtected.addToAllowed": "Lagre godkjenning for denne agenten og disse nøyaktige stiene",
  "ui.permission.configProtected.removeFromAllowed":
    "Fjern lagret godkjenning for denne agenten og disse nøyaktige stiene",
  "ui.permission.configProtected.addToDenied": "Lagre avvisning for denne agenten og disse nøyaktige stiene",
  "ui.permission.configProtected.removeFromDenied":
    "Fjern lagret avvisning for denne agenten og disse nøyaktige stiene",
  ...
  "settings.config.source.global": "Global konfigurasjon",
  "settings.config.source.local": "Arbeidsområde .kilo-konfigurasjon",
