...
export const dict = {
  ...
  "ui.permission.configProtected.edit": "Izmjene konfiguracijskih datoteka uvijek zahtijevaju odobrenje",
  "ui.permission.configProtected.access": "Pristup Kilo konfiguraciji uvijek zahtijeva odobrenje",
  "ui.permission.configProtected.scope": "Sačuvana odobrenja odnose se samo na {{agent}} i ove tačne putanje.",
  "ui.permission.configProtected.thisAgent": "ovog agenta",
  "ui.permission.configProtected.addToAllowed": "Sačuvaj odobrenje za ovog agenta i ove tačne putanje",
  "ui.permission.configProtected.removeFromAllowed": "Ukloni sačuvano odobrenje za ovog agenta i ove tačne putanje",
  "ui.permission.configProtected.addToDenied": "Sačuvaj zabranu za ovog agenta i ove tačne putanje",
  "ui.permission.configProtected.removeFromDenied": "Ukloni sačuvanu zabranu za ovog agenta i ove tačne putanje",
  ...
  "settings.config.source.global": "Globalna konfiguracija",
  "settings.config.source.local": "Konfiguracija .kilo radnog prostora",
