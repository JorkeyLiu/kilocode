...
export const dict = {
  ...
  "ui.permission.configProtected.edit": "設定檔編輯始終需要核准",
  "ui.permission.configProtected.access": "Kilo 設定存取始終需要核准",
  "ui.permission.configProtected.scope": "儲存的核准僅適用於 {{agent}} 與這些確切路徑。",
  "ui.permission.configProtected.thisAgent": "此代理",
  "ui.permission.configProtected.addToAllowed": "為此代理與這些確切路徑儲存核准",
  "ui.permission.configProtected.removeFromAllowed": "移除為此代理與這些確切路徑儲存的核准",
  "ui.permission.configProtected.addToDenied": "為此代理與這些確切路徑儲存拒絕",
  "ui.permission.configProtected.removeFromDenied": "移除為此代理與這些確切路徑儲存的拒絕",
  ...
  "ui.permission.provenance.why": "為何需要核准",
  "ui.permission.provenance.reason.ask": "由於尚無已儲存的規則允許此操作，因此需要核准。",
  "ui.permission.provenance.reason.askCeiling": "根據安全規則需要核准，只有針對此次請求的精確核准才能滿足要求。",
  "ui.permission.provenance.reason.deny": "此操作已被規則封鎖。",
  "ui.permission.provenance.reason.allow": "所有適用規則均允許此操作。",
  "ui.permission.provenance.layers": "相關範圍",
  "ui.permission.provenance.source.runtime": "執行階段安全",
  "ui.permission.provenance.source.global": "全域",
  "ui.permission.provenance.source.project": "專案",
  "ui.permission.provenance.source.agent": "代理",
  "ui.permission.provenance.source.session": "工作階段",
  "ui.permission.provenance.source.approval": "核准",
  "ui.permission.provenance.source.protectedFile": "受保護檔案",
  "ui.permission.provenance.decision.deny": "已封鎖",
  "ui.permission.provenance.decision.ask": "需要核准",
  "ui.permission.provenance.decision.askCeiling": "需要核准（安全規則）",
  "ui.permission.provenance.decision.allow": "已允許",
  "ui.permission.provenance.decision.noCeiling": "無限制",
  "ui.permission.provenance.ceiling.a": "硬性安全封鎖",
  "ui.permission.provenance.ceiling.b": "設定檔保護",
  "ui.permission.provenance.ceiling.c": "敏感檔案保護",
  ...
  "settings.config.source.global": "全域設定",
  "settings.config.source.local": "工作區 .kilo 設定",
