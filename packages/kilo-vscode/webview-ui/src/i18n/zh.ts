...
export const dict = {
  ...
  "provider.apiKey.manage.loading": "正在加载已保存的 API 密钥...",
  "provider.apiKey.manage.error": "无法加载 API 密钥",
  "provider.apiKey.manage.description": "您为 {{provider}} 保存的 API 密钥如下所示。请更新或移除。",
  "provider.connect.apiKey.show": "显示 API 密钥",
  "provider.connect.apiKey.hide": "隐藏 API 密钥",

  "provider.delete.toast.deleted.title": "{{provider}} 已删除",
  "provider.delete.toast.deleted.description": "{{provider}} 的配置和凭据已被移除。",
  "provider.delete.confirm.title": "删除 {{provider}}",
  "provider.delete.confirm.body": "此操作将永久移除自定义提供商配置及所有存储的凭据。",
  ...
  "ui.permission.configProtected.edit": "配置文件编辑始终需要审批",
  "ui.permission.configProtected.access": "Kilo 配置访问始终需要审批",
  "ui.permission.configProtected.scope": "保存的批准仅适用于 {{agent}} 和这些确切路径。",
  "ui.permission.configProtected.thisAgent": "此代理",
  "ui.permission.configProtected.addToAllowed": "为此代理和这些确切路径保存批准",
  "ui.permission.configProtected.removeFromAllowed": "移除为此代理和这些确切路径保存的批准",
  "ui.permission.configProtected.addToDenied": "为此代理和这些确切路径保存拒绝",
  "ui.permission.configProtected.removeFromDenied": "移除为此代理和这些确切路径保存的拒绝",
  ...
  "ui.permission.provenance.why": "为何需要审批",
  "ui.permission.provenance.reason.ask": "由于尚无已保存的规则允许此操作，因此需要审批。",
  "ui.permission.provenance.reason.askCeiling": "根据安全规则需要审批，只有针对此次请求的精确审批才能满足要求。",
  "ui.permission.provenance.reason.deny": "此操作已被规则阻止。",
  "ui.permission.provenance.reason.allow": "所有适用规则均允许此操作。",
  "ui.permission.provenance.layers": "相关范围",
  "ui.permission.provenance.source.runtime": "运行时安全",
  "ui.permission.provenance.source.global": "全局",
  "ui.permission.provenance.source.project": "项目",
  "ui.permission.provenance.source.agent": "代理",
  "ui.permission.provenance.source.session": "会话",
  "ui.permission.provenance.source.approval": "审批",
  "ui.permission.provenance.source.protectedFile": "受保护文件",
  "ui.permission.provenance.decision.deny": "已阻止",
  "ui.permission.provenance.decision.ask": "需要审批",
  "ui.permission.provenance.decision.askCeiling": "需要审批（安全规则）",
  "ui.permission.provenance.decision.allow": "已允许",
  "ui.permission.provenance.decision.noCeiling": "无限制",
  "ui.permission.provenance.ceiling.a": "硬性安全阻止",
  "ui.permission.provenance.ceiling.b": "配置文件保护",
  "ui.permission.provenance.ceiling.c": "敏感文件保护",
  ...
  "settings.config.source.global": "全局配置",
  "settings.config.source.local": "工作区 .kilo 配置",
