...
export const dict = {
  ...
  "provider.apiKey.manage.loading": "保存されたAPIキーを読み込み中...",
  "provider.apiKey.manage.error": "APIキーを読み込めません",
  "provider.apiKey.manage.description":
    "{{provider}} の保存済みAPIキーが以下に表示されています。更新または削除してください。",
  "provider.connect.apiKey.show": "APIキーを表示",
  "provider.connect.apiKey.hide": "APIキーを非表示",
  ...
  "ui.permission.configProtected.edit": "設定ファイルの編集には常に承認が必要です",
  "ui.permission.configProtected.access": "Kilo 設定へのアクセスには常に承認が必要です",
  "ui.permission.configProtected.scope": "保存された承認は {{agent}} とこれらの正確なパスのみに適用されます。",
  "ui.permission.configProtected.thisAgent": "このエージェント",
  "ui.permission.configProtected.addToAllowed": "このエージェントとこれらの正確なパスの承認を保存",
  "ui.permission.configProtected.removeFromAllowed": "このエージェントとこれらの正確なパスに保存された承認を削除",
  "ui.permission.configProtected.addToDenied": "このエージェントとこれらの正確なパスの拒否を保存",
  "ui.permission.configProtected.removeFromDenied": "このエージェントとこれらの正確なパスに保存された拒否を削除",
  ...
  "settings.config.source.global": "グローバル設定",
  "settings.config.source.local": "ワークスペース .kilo 設定",
