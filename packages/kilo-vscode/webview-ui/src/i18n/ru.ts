...
export const dict = {
  ...
  "provider.apiKey.manage.loading": "Загрузка сохранённого ключа API...",
  "provider.apiKey.manage.error": "Не удалось загрузить ключ API",
  "provider.apiKey.manage.description":
    "Ваш сохранённый ключ API для {{provider}} показан ниже. Обновите или удалите его.",
  "provider.connect.apiKey.show": "Показать ключ API",
  "provider.connect.apiKey.hide": "Скрыть ключ API",
  ...
  "ui.permission.configProtected.edit": "Изменения файлов конфигурации всегда требуют одобрения",
  "ui.permission.configProtected.access": "Доступ к конфигурации Kilo всегда требует одобрения",
  "ui.permission.configProtected.scope": "Сохранённые одобрения применяются только к {{agent}} и этим точным путям.",
  "ui.permission.configProtected.thisAgent": "этому агенту",
  "ui.permission.configProtected.addToAllowed": "Сохранить одобрение для этого агента и этих точных путей",
  "ui.permission.configProtected.removeFromAllowed":
    "Удалить сохранённое одобрение для этого агента и этих точных путей",
  "ui.permission.configProtected.addToDenied": "Сохранить запрет для этого агента и этих точных путей",
  "ui.permission.configProtected.removeFromDenied": "Удалить сохранённый запрет для этого агента и этих точных путей",
  ...
  "provider.custom.models.fetch.available": "Доступно из API",
  ...
  "settings.config.source.global": "Глобальная конфигурация",
  "settings.config.source.local": "Конфигурация .kilo рабочей области",
