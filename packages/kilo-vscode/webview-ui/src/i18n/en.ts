...
export const dict = {
  ...
  "provider.apiKey.manage.loading": "Loading saved API key...",
  "provider.apiKey.manage.error": "Unable to load API key",
  "provider.apiKey.manage.description": "Your saved API key for {{provider}} is shown below. Update or remove it.",
  "provider.connect.apiKey.show": "Show API Key",
  "provider.connect.apiKey.hide": "Hide API Key",
  ...
  "provider.custom.models.fetch.available": "Available from API",
  ...
  "settings.config.source.global": "Global config",
  "settings.config.source.local": "Workspace .kilo config",
  ...
  "workStyle.choice.autonomous.permissions": "Auto-approves all permission requests. Never asks.",
  "workStyle.choice.autonomous.bash": "Runs terminal commands without approval and never asks.",
