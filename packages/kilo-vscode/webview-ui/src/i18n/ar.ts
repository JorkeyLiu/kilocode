...
export const dict = {
  ...
  "provider.apiKey.manage.loading": "جارٍ تحميل مفتاح API المحفوظ...",
  "provider.apiKey.manage.error": "تعذر تحميل مفتاح API",
  "provider.apiKey.manage.description": "مفتاح API المحفوظ لـ {{provider}} موضح أدناه. قم بتحديثه أو إزالته.",
  "provider.connect.apiKey.show": "إظهار مفتاح API",
  "provider.connect.apiKey.hide": "إخفاء مفتاح API",
  ...
  "ui.permission.configProtected.edit": "تتطلب تعديلات ملفات التكوين الموافقة دائمًا",
  "ui.permission.configProtected.access": "يتطلب الوصول إلى تكوين Kilo الموافقة دائمًا",
  "ui.permission.configProtected.scope": "تنطبق الموافقات المحفوظة على {{agent}} وهذه المسارات المحددة فقط.",
  "ui.permission.configProtected.thisAgent": "هذا العامل",
  "ui.permission.configProtected.addToAllowed": "حفظ الموافقة لهذا العامل وهذه المسارات المحددة",
  "ui.permission.configProtected.removeFromAllowed": "إزالة الموافقة المحفوظة لهذا العامل وهذه المسارات المحددة",
  "ui.permission.configProtected.addToDenied": "حفظ الرفض لهذا العامل وهذه المسارات المحددة",
  "ui.permission.configProtected.removeFromDenied": "إزالة الرفض المحفوظ لهذا العامل وهذه المسارات المحددة",
  ...
  "settings.config.source.global": "الإعدادات العامة",
  "settings.config.source.local": "إعدادات .kilo لمساحة العمل",
