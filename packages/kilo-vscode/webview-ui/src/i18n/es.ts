...
export const dict = {
  ...
  "provider.apiKey.manage.loading": "Cargando clave API guardada...",
  "provider.apiKey.manage.error": "No se pudo cargar la clave API",
  "provider.apiKey.manage.description":
    "Su clave API guardada para {{provider}} se muestra a continuación. Actualice o elimínela.",
  "provider.connect.apiKey.show": "Mostrar clave API",
  "provider.connect.apiKey.hide": "Ocultar clave API",
  ...
  "ui.permission.configProtected.edit": "Las ediciones de archivos de configuración siempre requieren aprobación",
  "ui.permission.configProtected.access": "El acceso a la configuración de Kilo siempre requiere aprobación",
  "ui.permission.configProtected.scope":
    "Las aprobaciones guardadas solo se aplican a {{agent}} y estas rutas exactas.",
  "ui.permission.configProtected.thisAgent": "este agente",
  "ui.permission.configProtected.addToAllowed": "Guardar aprobación para este agente y estas rutas exactas",
  "ui.permission.configProtected.removeFromAllowed":
    "Quitar aprobación guardada para este agente y estas rutas exactas",
  "ui.permission.configProtected.addToDenied": "Guardar denegación para este agente y estas rutas exactas",
  "ui.permission.configProtected.removeFromDenied": "Quitar denegación guardada para este agente y estas rutas exactas",
  ...
  "provider.custom.models.fetch.available": "Disponibles desde la API",
  ...
  "settings.config.source.global": "Configuración global",
  "settings.config.source.local": "Configuración .kilo del espacio de trabajo",
