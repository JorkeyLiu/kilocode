...
export const dict = {
  ...
  "ui.permission.configProtected.scope": "Las aprobaciones guardadas solo se aplican a {{agent}} y estas rutas exactas.",
  ...
  "ui.permission.configProtected.removeFromAllowed": "Quitar aprobación guardada para este agente y estas rutas exactas",
