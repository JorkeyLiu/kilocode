...
export const dict = {
  ...
  "ui.permission.configProtected.edit": "Редагування файлів конфігурації завжди потребує схвалення",
  "ui.permission.configProtected.access": "Доступ до конфігурації Kilo завжди потребує схвалення",
  "ui.permission.configProtected.scope": "Збережені схвалення застосовуються лише до {{agent}} і цих точних шляхів.",
  "ui.permission.configProtected.thisAgent": "цього агента",
  "ui.permission.configProtected.addToAllowed": "Зберегти схвалення для цього агента та цих точних шляхів",
  "ui.permission.configProtected.removeFromAllowed":
    "Видалити збережене схвалення для цього агента та цих точних шляхів",
  "ui.permission.configProtected.addToDenied": "Зберегти відхилення для цього агента та цих точних шляхів",
  "ui.permission.configProtected.removeFromDenied":
    "Видалити збережене відхилення для цього агента та цих точних шляхів",
  ...
  "settings.config.source.global": "Глобальна конфігурація",
  "settings.config.source.local": "Конфігурація .kilo робочої області",
