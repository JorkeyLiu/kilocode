...
export const dict = {
  ...
  "ui.permission.configProtected.edit": "구성 파일 편집에는 항상 승인이 필요합니다",
  "ui.permission.configProtected.access": "Kilo 구성 액세스에는 항상 승인이 필요합니다",
  "ui.permission.configProtected.scope": "저장된 승인은 {{agent}} 및 이 정확한 경로에만 적용됩니다.",
  "ui.permission.configProtected.thisAgent": "이 에이전트",
  "ui.permission.configProtected.addToAllowed": "이 에이전트 및 이 정확한 경로에 대한 승인 저장",
  "ui.permission.configProtected.removeFromAllowed": "이 에이전트 및 이 정확한 경로에 저장된 승인 제거",
  "ui.permission.configProtected.addToDenied": "이 에이전트 및 이 정확한 경로에 대한 거부 저장",
  "ui.permission.configProtected.removeFromDenied": "이 에이전트 및 이 정확한 경로에 저장된 거부 제거",
  ...
  "settings.config.source.global": "글로벌 구성",
  "settings.config.source.local": "작업 영역 .kilo 구성",
