...
export const dict = {
  ...
  "provider.delete.confirm.body":
    "Isso removerá permanentemente a configuração do provedor personalizado e todas as credenciais armazenadas.",
  ...
  "ui.permission.configProtected.edit": "Edições de arquivos de configuração sempre exigem aprovação",
  "ui.permission.configProtected.access": "O acesso à configuração do Kilo sempre exige aprovação",
  "ui.permission.configProtected.scope": "As aprovações salvas se aplicam apenas a {{agent}} e a esses caminhos exatos.",
  "ui.permission.configProtected.thisAgent": "este agente",
  "ui.permission.configProtected.addToAllowed": "Salvar aprovação para este agente e esses caminhos exatos",
  "ui.permission.configProtected.removeFromAllowed": "Remover aprovação salva para este agente e esses caminhos exatos",
  "ui.permission.configProtected.addToDenied": "Salvar negação para este agente e esses caminhos exatos",
  "ui.permission.configProtected.removeFromDenied": "Remover negação salva para este agente e esses caminhos exatos",
  ...
  "migration.whatsNew.features.agentManager.detail":
    "Uma interface unificada para executar múltiplos agentes em paralelo — monitore o progresso, troque de contexto e revise alterações em um só lugar.",
