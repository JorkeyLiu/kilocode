...
export const dict = {
  ...
  "ui.permission.configProtected.edit": "การแก้ไขไฟล์คอนฟิกต้องได้รับการอนุมัติเสมอ",
  "ui.permission.configProtected.access": "การเข้าถึงคอนฟิกของ Kilo ต้องได้รับการอนุมัติเสมอ",
  "ui.permission.configProtected.scope": "การอนุมัติที่บันทึกไว้ใช้กับ {{agent}} และพาธที่ระบุเหล่านี้เท่านั้น",
  "ui.permission.configProtected.thisAgent": "เอเจนต์นี้",
  "ui.permission.configProtected.addToAllowed": "บันทึกการอนุมัติสำหรับเอเจนต์นี้และพาธที่ระบุเหล่านี้",
  "ui.permission.configProtected.removeFromAllowed": "นำการอนุมัติที่บันทึกไว้สำหรับเอเจนต์นี้และพาธที่ระบุเหล่านี้ออก",
  "ui.permission.configProtected.addToDenied": "บันทึกการปฏิเสธสำหรับเอเจนต์นี้และพาธที่ระบุเหล่านี้",
  "ui.permission.configProtected.removeFromDenied": "นำการปฏิเสธที่บันทึกไว้สำหรับเอเจนต์นี้และพาธที่ระบุเหล่านี้ออก",
  ...
  "settings.config.source.global": "การตั้งค่าระดับโกลบอล",
  "settings.config.source.local": "การตั้งค่า .kilo ของพื้นที่ทำงาน",
