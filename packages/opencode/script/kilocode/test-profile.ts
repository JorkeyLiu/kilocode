    ...
    darwin: {
      ...
      groups: {
        ...
        kilo: [
          ...
          "kilocode/p4-4-g2-hardening.test.ts",
          "kilocode/p4-4-g2-preset-catalog-removal.test.ts",
          ...
          "kilocode/p4-4-tui-attach-canonical.test.ts",
          "kilocode/p4-4-tui-canonical-source-removal.test.ts",
          "kilocode/p4-4-tui-cli-nested-canonical.test.ts",
          "kilocode/p4-4-tui-config-console-nested.test.ts",
          "kilocode/p4-4-tui-migrate-kilo-config-removal.test.ts",
          "kilocode/p4-4-tui-model-dialog-preset-removal.test.ts",
          "kilocode/p4-4-tui-plugin-global-scope.test.ts",
