  ...
  Effect.gen(function* () {
    ...
    const result: Interface = {
      ...
      latest: Effect.fn("Installation.latest")(function* (installMethod?: Method) {
        ...
        // releases and returns a tag that breaks version resolution. Use the public
        // registry directly: a curl-installed binary is not tied to any project's npm config.
        const response = yield* httpOk.execute(
