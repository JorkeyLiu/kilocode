...
export const FD_CAPABILITIES = ["session/cancelQueued", "session/update", "session/fork", "session/create", "session/status", "session/get", "session/messages", "session/children"] as const
