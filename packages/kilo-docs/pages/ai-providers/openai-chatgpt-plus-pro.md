...
**Can I use GPT models in cloud features?**
No. For cloud features, use GPT models through the [Kilo Gateway](/docs/gateway), which gives access to 500+ models including the latest GPT releases.
