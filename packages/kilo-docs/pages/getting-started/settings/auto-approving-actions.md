...
| `agent_manager` | Starting Agent Manager sessions |
...
For the `agent_manager` tool, runtime approvals use the requested capability `start` as the pattern.
