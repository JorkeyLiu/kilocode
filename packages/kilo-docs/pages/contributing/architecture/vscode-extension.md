...
| Non-goals | No `SessionOperation`/DB/EventV2/retention/cache authority, no mutation dispatch, no cutover/G3 closure, no Gates B/C/D/P4.4 closure, no `session/messages`, no new protocol design. B6 is additive carrier evidence, not P4.4-G3/Gate closure. |
