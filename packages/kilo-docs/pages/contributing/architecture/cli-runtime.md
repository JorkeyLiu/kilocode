...
| Cross-platform residual | Same as B1: Darwin unit/integration for fd3/fd4; Linux/Windows not overstated, both fail-closed. |

G3 remains **Active** and SDK authoritative. No cutover, no Gates C/D/E/F/P4.4 closure, no Linux/Windows production proof.
