...
explicitly remains out of P3.2 scope; P3.3-P3.4, P4, and P5 remain Not
started; R2 and R6 were revised by a
...
Current phase: **P3 Active — P3.1 Complete (2026-08-15); P3.2 Complete (2026-08-16)**; **P3.3-P3.4, P4, P5 Not started** (P0 Complete 2026-08-12; P1 Complete 2026-08-14; P2 exit evidence recorded in sections 4, 5, 6, 8; P3.1 exit evidence recorded in sections 4, 5, 7, 8; P3.2 exit evidence recorded in sections 4, 5, 7, 8; P3 overall is Active, never Complete until P3.4 exits).
...
| P3 | Product removal | Active — P3.1 Complete (2026-08-15); P3.2 Complete (2026-08-16); P3.3-P3.4 Not started | test: `packages/kilo-vscode/tests/unit/sidebar-removal.test.ts`, `packages/kilo-vscode/tests/unit/chat-target.test.ts`, `packages/kilo-vscode/tests/e2e/runner.ts`, `packages/kilo-vscode/script/e2e-probe.ts` (focused real Extension Host `test:e2e:sidebar-removal` passed); P3.2: `packages/kilo-vscode/tests/unit/worktree-removal.test.ts`, `packages/kilo-vscode/tests/unit/diff-viewer-removal.test.ts`, `packages/opencode/test/kilocode/agent-manager-absence.test.ts`, `packages/kilo-vscode/tests/e2e/runner.ts` + `packages/kilo-vscode/script/e2e-probe-worktree.ts` (focused real Extension Host `test:e2e:worktree-removal` passed; final campaign `p3-2-final-2026-08-16T03-09-32-000Z/`); doc: `packages/kilo-docs/pages/contributing/architecture/vscode-extension.md`, `specs/vscode-orchestrator/evidence/p0-baseline/p3-1-sidebar-2026-08-15T11-19-02-000Z/benchmark.jsonl`, `specs/vscode-orchestrator/evidence/p0-baseline/p3-2-final-2026-08-16T03-18-36-000Z/benchmark.jsonl`, `.changeset/remove-sidebar-chat.md`, `.changeset/agent-manager-root-local-sessions.md` | P3.1 (sidebar, LOCK-001) Complete 2026-08-15 with per-category removal evidence (section 7), rollback = git revert of the P3.1 removal commit(s) (no feature flag/shim), and a descriptive scenario-1 cold-start performance comparison vs the P0 baseline (section 8); P3.2 (managed worktree infrastructure + custom Diff Viewer/Diff Virtual, LOCK-002) Complete 2026-08-16 with per-category removal evidence (section 7), rollback = git revert of the P3.2 removal commit(s) (no feature flag/shim), and a descriptive scenario-1 cold-start performance comparison vs the P0 baseline (section 8); P3.3-P3.4 (cloud/JetBrains/Console/KiloClaw, indexing/memory/context-management/autocomplete) Not started; P3 overall is Active, never Complete until P3.4 exits |
...
- Status: Active — P3.1 Complete (2026-08-15); P3.2 Complete (2026-08-16); P3.3-P3.4 Not started. P3 overall
...
- Exit checklist (P3-wide; each removal subphase completes its own subset):
  ...
  - Evidence: issue: - | PR: - | test: `packages/kilo-vscode/tests/unit/sidebar-removal.test.ts`, `packages/kilo-vscode/tests/unit/chat-target.test.ts`, `packages/kilo-vscode/tests/unit/worktree-removal.test.ts`, `packages/kilo-vscode/tests/unit/diff-viewer-removal.test.ts`, `packages/opencode/test/kilocode/agent-manager-absence.test.ts`, `packages/kilo-vscode/tests/e2e/runner.ts`, `packages/kilo-vscode/script/e2e-probe.ts`, `packages/kilo-vscode/script/e2e-probe-worktree.ts` | doc: `packages/kilo-docs/pages/contributing/architecture/vscode-extension.md`, `specs/vscode-orchestrator/evidence/p0-baseline/p3-1-sidebar-2026-08-15T11-19-02-000Z/benchmark.jsonl`, `specs/vscode-orchestrator/evidence/p0-baseline/p3-2-final-2026-08-16T03-18-36-000Z/benchmark.jsonl`, `.changeset/remove-sidebar-chat.md`, `.changeset/agent-manager-root-local-sessions.md`
...
- Next actions: P3.3 (cloud/JetBrains/Console/KiloClaw, LOCK-003) is the next subphase and remains Not started; P3.4 follows. Keep the P3.2 static contract tests (`worktree-removal.test.ts`, `diff-viewer-removal.test.ts`, `agent-manager-absence.test.ts`) and the `test:e2e:worktree-removal` scenario green.
...
**Complete (2026-08-15)** and the worktree-infrastructure and custom-Diff-Viewer
rows are **Complete (2026-08-16)** with per-category objective evidence, and the
...
|---|---|---|---|---|---|
| Webview message types | 332 distinct `type` literals (Q3 approved 2026-08-12; inventory §4.4/§9) | −58 (P3.2, 2026-08-16: recount 274 = WebviewMessage 149 + ExtensionMessage 125, disjoint sets; delta −58 from the P3.1 332 — worktree/diff/agent-manager-run message types retired; P3.1 contributed delta 0, 2026-08-15) | TBD | TBD | doc: `specs/vscode-orchestrator/p0-current-state-inventory.md` (§4.4 reproducible count); recount via `rg -o 'type: "[a-zA-Z0-9_.-]+"'` over `webview-ui/src/types/messages/webview-messages.ts` (149) + `extension-messages.ts` (125) |
| Provider methods | 250 v2 SDK public methods (Q3 approved 2026-08-12; inventory §4.3/§9) | −11 (P3.2, 2026-08-16: recount 239; delta −11 = Worktree 7 + BranchName 1 + AgentManager list/reply/reject 3; P3.1 contributed delta 0, 2026-08-15) | TBD | TBD | doc: `specs/vscode-orchestrator/p0-current-state-inventory.md` (§4.4 reproducible count); recount via the inventory §10 `awk` over `sdk.gen.ts` (239) |
| Webview entry points | 6 esbuild webview entry points (Q3 approved 2026-08-12; inventory §4.4/§9) | −2 (P3.2, 2026-08-16: recount 4 — `diff-viewer` and `diff-virtual` bundles retired; P3.1 contributed delta 0, 2026-08-15) | TBD | TBD | doc: `specs/vscode-orchestrator/p0-current-state-inventory.md` (§4.4 reproducible count); current entries in `packages/kilo-vscode/esbuild.js` (agent-manager, kiloclaw, marketplace, src/index.tsx) |
...
| Removal items with full evidence | 0 (no removal complete; residue only, inventory §5) | 3 (P3.1, 2026-08-15: ordinary single-chat sidebar row complete; P3.2, 2026-08-16: worktree-infrastructure and custom-Diff-Viewer rows complete; P3.3-P3.4 deltas pending) | TBD | TBD | doc: `specs/vscode-orchestrator/p0-current-state-inventory.md` (§5); tracker §7 |

The `Delta at P3` column above reflects **P3.1 + P3.2** (2026-08-15/2026-08-16):
...
`diff-virtual` retired). P3.3-P3.4 complexity and removal deltas remain pending
and stay `TBD` until their subphases record evidence.
...
- Canonical architecture docs: `packages/kilo-docs/pages/contributing/architecture/` (LOCK-013; `vscode-extension.md` updated in the P2 work unit to document the implemented env-gated fixture bridge, in the P3.1 work unit to document the implemented sidebar removal, and in the P3.2 work unit to document the managed-worktree/Diff removal and root-local Agent Manager model)
