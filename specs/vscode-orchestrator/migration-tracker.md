...
and [ADR-0004](../adr/0004-architecture-first-direct-reconstruction.md)
...
decisions in section 9), the no-threshold performance comparison policy (R7
...
(section 9); P1-P5 are Not started. No
...
| P4 | Private runtime and configuration | Not started | - | Subphases P4.1-P4.5 (file-authoritative read/write model, private runtime entrypoint, legacy-reader cutover, removal evidence + transport narrowing, old CLI/server deletion); owned by runtime spec section 7. P4.2 additionally requires the Failure/Outcome/Recovery contract evidence and the four R decisions R11-R14 (runtime spec sections 7.2, 9); post-reconstruction error maturity (runtime spec section 7.3) is separately planned and is not a P4.2 gate |
...
- Scope (owned by runtime spec sections 3-7):
  ...
  - P4.2: private runtime entrypoint and snapshot API (extension-owned headless
    ...
    per runtime spec section 7.2 with R11-R14 resolved (section 9)
...
do not gate P0 (Complete) or P1. Post-reconstruction error maturity (runtime
